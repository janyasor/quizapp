var allQuestions = [
    ...
    "You tell one of your mutual friends that you like her", "You wait for her to come to you"], answerValues: [4,3,2,1]},
    ...
    "You have one date because you're a one woman kind of guy", "You have one date. You don't date much, in general."], answerValues: [4,3,2,1]},
    ...
    "You like to have fun as much as the next guy, as long as things don't get too out of hand", "I like to plan ahead, no matter what the situation, work or play"], answerValues: [4,3,2,1]}
];
